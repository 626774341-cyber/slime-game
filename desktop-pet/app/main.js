...
function injectPetUI() {
  ...
  st.textContent = [
    ...
    '/* ❤️ 陪伴时间胶囊：顶部左侧 */',
    '#petCompanion { position: fixed; top: 14px; left: 12px; z-index: 33;',
    ...
    '/* 版本徽标：陪伴时间右侧 */',
    '#petVer { position: fixed; top: 17px; left: auto; right: auto;',
    '  margin-left: 160px; z-index: 33; font-size: 10px;',
    '  color: #7a97b0; opacity: .5; pointer-events: none; user-select: none; }',
    '/* 💤 睡觉气泡 + 头顶名牌 + 拖喂提示 */',
